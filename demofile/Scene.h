...
class Scene
{
    ...
    public :
        ...
        void RegisterSystem( const std::type_info* NodeType, MyUUID& ID );
    ...
    private :
        void CheckSystemValidity( const std::type_info* NodeType );
        void UpdateSequence();

    public :
        TypeUnSet GetNodeTypeData();
        TypeUnSet GetPeddingSystemNodeTypeData();

        MyUUIDUnSet& GetNodeIDData( const std::type_info* Type );
        MyUUIDUnSet& GetSystemIDData();
        MyUUIDUnSet& GetSystemIDData( const std::type_info* Type );
